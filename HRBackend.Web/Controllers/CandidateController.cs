...
public class CandidateController : ControllerBase
{
    ...
    public async Task<IActionResult> CreateCandidate([FromQuery] CandidateCreateRequest request, CancellationToken cancellationToken)
    {
        try
        {
    ...
    public async Task<IActionResult> UpdateCandidate([FromQuery] CandidateUpdateRequest request, CancellationToken cancellationToken)
    {
        try
        {
